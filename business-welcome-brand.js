// NR BizPro — dynamic welcome + business isolation + EV billing details loader
(function(){'use strict';
 ...
 function boot(){setTimeout(apply,50);setTimeout(()=>load('business-data-isolation-fix.js?v=20260917-3','data-nr-business-isolation'),100);setTimeout(()=>load('business-bill-isolation-fix.js?v=20260917-1','data-nr-bill-isolation'),130);setTimeout(()=>load('ev-billing-details-fix.js?v=20260917-1','data-nr-ev-billing'),160)}
