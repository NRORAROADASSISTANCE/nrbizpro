// NR BizPro final UI fallback — app-only and throttled to avoid public-page CPU churn.
(function(){
  function appVisible(){
  ...
  function ensureRawProduct(){
    ...
    if(!Array.from(sel.options).some(o=>o.value==='Raw Product')){const o=document.createElement('option');o.value='Raw Product';o.textContent='Raw Product';sel.appendChild(o)}
  }
  function patchModal(){
    if(!appVisible()||typeof window.openItemModal!=='function'||window.openItemModal.__finalUiFix)return;
